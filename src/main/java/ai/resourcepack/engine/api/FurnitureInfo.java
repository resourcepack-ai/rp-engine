...
/**
 * What a content pack said a piece of furniture is.
 *
 * <p>Furniture is an item you can put down. It renders as a display entity
...
public final class FurnitureInfo {
    ...
    private FurnitureInfo(ContentId id, ContentId item, Facing facing,
    ...
    /** Engine internal; built by the furniture loader. */
    public static FurnitureInfo of(ContentId id, ContentId item, Facing facing,
                                   float scale, float width, float height, boolean solid) {
     ...
     *
     * <p>Furniture does not define its own look. It names an item, and the item
     ...
     *
     * <p>A display entity has no collision at all, so solid furniture needs a
     * real block behind it. That is a barrier at the anchor: invisible, solid,
     * and removed when the furniture is broken.
     */
